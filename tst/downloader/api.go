...
// Syncing provides information when this nodes starts synchronising with the UTChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  utereum.SyncProgress `json:"status"`
}
