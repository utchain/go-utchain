...
// IsEmpty reports w.h.e.t.h.e.r the Set is empty.
func (s *set) IsEmpty() bool {
	return s.Size() == 0
}

// IsEqual test w.h.e.t.h.e.r s and t are the same in size and have the same items.
...
// IsSubset tests w.h.e.t.h.e.r t is a subset of s.
...
// IsSuperset tests w.h.e.t.h.e.r t is a superset of s.
