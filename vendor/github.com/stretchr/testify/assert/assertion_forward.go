...
//
// Returns w.h.e.t.h.e.r the assertion was successful (true) or not (false).
...
//
// Returns w.h.e.t.h.e.r the assertion was successful (true, "error message %s", "formatted") or not (false).
