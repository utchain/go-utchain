 ...
 *
 * One decision you will have to make is w.h.e.t.h.e.r to use the synchronous
 ...
 * \param unref_devices w.h.e.t.h.e.r to unref the devices in the list
 */
 ...
 *
 * \param dev_handle a device handle
 * \param enable w.h.e.t.h.e.r to enable or disable auto kernel driver detachment
 *
