...
// SetCtrlCAborts sets w.h.e.t.h.e.r Prompt on a supported terminal will return an
...
// SetMultiLineMode sets w.h.e.t.h.e.r line is auto-wrapped. The default is false (single line).
...
// w.h.e.t.h.e.r to retry the call to, or return the error returned by, readNext.
