...
// Condition have flag EastAsianWidth w.h.e.t.h.e.r the current locale is CJK or not.
...
// IsAmbiguousWidth returns w.h.e.t.h.e.r is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns w.h.e.t.h.e.r is neutral width or not.
