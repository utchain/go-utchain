...
// in order to distinguish w.h.e.t.h.e.r current folder should be re-registered in
...
// watched is made in order to check w.h.e.t.h.e.r an action comes from a directory or
...
// gensys decides w.h.e.t.h.e.r the Windows action, system-independent event or both
