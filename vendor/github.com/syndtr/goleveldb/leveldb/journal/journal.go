...
//
// There are four chunk types: w.h.e.t.h.e.r the chunk is the full journal, or the
...
type Reader struct {
	...
	n int
	// last is w.h.e.t.h.e.r the current chunk is the last chunk of the journal.
	last bool
...
type Writer struct {
	...
	written int
	// first is w.h.e.t.h.e.r the current chunk is the first chunk of the journal.
	first bool
	// pending is w.h.e.t.h.e.r a chunk is buffered but not yet written.
	pending bool
	// err is any accumulated error.
	err error
	// buf is the buffer.
