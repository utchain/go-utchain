...
// private reports w.h.e.t.h.e.r the Tag consists solely of a private use tag.
...
// w.h.e.t.h.e.r there was any change.
...
// The confidence level indicates w.h.e.t.h.e.r a value was explicitly specified,
// w.h.e.t.h.e.r it is typically the only possible value, or w.h.e.t.h.e.r there is
// an ambiguity.
type Confidence int
...
// wasn't found. The hasExt return value reports w.h.e.t.h.e.r an -u extension was present.
...
func (t Tag) findTypeForKey(key string) (start, end int, hasExt bool) {
	...
	for {
		...
		if p3 := p + 3; s[p3] == '-' {
			// Found a key.
			// Check w.h.e.t.h.e.r we just processed the key that was requested.
			if curKey == key {
				return start, p, true
			}
...
// IsCountry returns w.h.e.t.h.e.r this region is a country or autonomous area. This
...
// IsGroup returns w.h.e.t.h.e.r this region defines a collection of regions. This
// includes non-standard definitions from CLDR.
...
// Contains returns w.h.e.t.h.e.r Region c is contained by Region r. It returns true
// if c == r.
