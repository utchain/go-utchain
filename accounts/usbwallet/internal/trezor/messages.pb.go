...
const (
	...
	MessageType_MessageType_UTChainGetAddress       MessageType = 56
	MessageType_MessageType_UTChainAddress          MessageType = 57
	MessageType_MessageType_UTChainSignTx           MessageType = 58
	MessageType_MessageType_UTChainTxRequest        MessageType = 59
	MessageType_MessageType_UTChainTxAck            MessageType = 60
	...
	MessageType_MessageType_UTChainSignMessage      MessageType = 64
	MessageType_MessageType_UTChainVerifyMessage    MessageType = 65
	MessageType_MessageType_UTChainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_UTChainGetAddress",
	57:  "MessageType_UTChainAddress",
	58:  "MessageType_UTChainSignTx",
	59:  "MessageType_UTChainTxRequest",
	60:  "MessageType_UTChainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_UTChainSignMessage",
	65:  "MessageType_UTChainVerifyMessage",
	66:  "MessageType_UTChainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_UTChainGetAddress":       56,
	"MessageType_UTChainAddress":          57,
	"MessageType_UTChainSignTx":           58,
	"MessageType_UTChainTxRequest":        59,
	"MessageType_UTChainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_UTChainSignMessage":      64,
	"MessageType_UTChainVerifyMessage":    65,
	"MessageType_UTChainMessageSignature": 66,
...
// *
// Request: Ask device for UTChain address corresponding to address_n path
// @next PassphraseRequest
// @next UTChainAddress
// @next Failure
type UTChainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *UTChainGetAddress) Reset()                    { *m = UTChainGetAddress{} }
func (m *UTChainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*UTChainGetAddress) ProtoMessage()               {}
func (*UTChainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *UTChainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *UTChainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an UTChain address derived from device private seed
// @prev UTChainGetAddress
type UTChainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *UTChainAddress) Reset()                    { *m = UTChainAddress{} }
func (m *UTChainAddress) String() string            { return proto.CompactTextString(m) }
func (*UTChainAddress) ProtoMessage()               {}
func (*UTChainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *UTChainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next UTChainTxRequest
// @next Failure
type UTChainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *UTChainSignTx) Reset()                    { *m = UTChainSignTx{} }
func (m *UTChainSignTx) String() string            { return proto.CompactTextString(m) }
func (*UTChainSignTx) ProtoMessage()               {}
func (*UTChainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *UTChainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *UTChainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *UTChainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *UTChainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *UTChainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *UTChainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *UTChainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *UTChainSignTx) GetDataLength() uint32 {
...
func (m *UTChainSignTx) GetChainId() uint32 {
...
func (m *UTChainTxRequest) Reset()                    { *m = UTChainTxRequest{} }
func (m *UTChainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*UTChainTxRequest) ProtoMessage()               {}
func (*UTChainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *UTChainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *UTChainTxRequest) GetSignatureV() uint32 {
...
func (m *UTChainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *UTChainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev UTChainTxRequest
// @next UTChainTxRequest
type UTChainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *UTChainTxAck) Reset()                    { *m = UTChainTxAck{} }
func (m *UTChainTxAck) String() string            { return proto.CompactTextString(m) }
func (*UTChainTxAck) ProtoMessage()               {}
func (*UTChainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *UTChainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next UTChainMessageSignature
// @next Failure
type UTChainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *UTChainSignMessage) Reset()                    { *m = UTChainSignMessage{} }
func (m *UTChainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*UTChainSignMessage) ProtoMessage()               {}
func (*UTChainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *UTChainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *UTChainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type UTChainVerifyMessage struct {
...
func (m *UTChainVerifyMessage) Reset()                    { *m = UTChainVerifyMessage{} }
func (m *UTChainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*UTChainVerifyMessage) ProtoMessage()               {}
func (*UTChainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *UTChainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *UTChainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *UTChainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev UTChainSignMessage
type UTChainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *UTChainMessageSignature) Reset()                    { *m = UTChainMessageSignature{} }
func (m *UTChainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*UTChainMessageSignature) ProtoMessage()               {}
func (*UTChainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *UTChainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *UTChainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UTChainGetAddress)(nil), "UTChainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*UTChainAddress)(nil), "UTChainAddress")
	...
	proto.RegisterType((*UTChainSignTx)(nil), "UTChainSignTx")
	proto.RegisterType((*UTChainTxRequest)(nil), "UTChainTxRequest")
	proto.RegisterType((*UTChainTxAck)(nil), "UTChainTxAck")
	proto.RegisterType((*UTChainSignMessage)(nil), "UTChainSignMessage")
	proto.RegisterType((*UTChainVerifyMessage)(nil), "UTChainVerifyMessage")
	proto.RegisterType((*UTChainMessageSignature)(nil), "UTChainMessageSignature")
