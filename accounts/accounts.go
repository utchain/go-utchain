...
// Package accounts implements high level UTChain account management.
package accounts
...
// Account represents an UTChain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // UTChain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain utereum.ChainStateReader)
