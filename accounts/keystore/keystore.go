...
// See https://github.com/utereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given UTChain presale wallet and stores
