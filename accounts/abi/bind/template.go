...
import "github.com/utchain/go-utchain/accounts/abi"
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new UTChain contract, binding an instance of {{.Type}} to it.
	...
	// {{.Type}} is an auto generated Go binding around an UTChain contract.
	type {{.Type}} struct {
	...
	// {{.Type}}Caller is an auto generated read-only Go binding around an UTChain contract.
	type {{.Type}}Caller struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Transactor is an auto generated write-only Go binding around an UTChain contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Filterer is an auto generated log filtering Go binding around an UTChain contract events.
	type {{.Type}}Filterer struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around an UTChain contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around an UTChain contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around an UTChain contract,
	...
	// {{.Type}}Raw is an auto generated low-level Go binding around an UTChain contract.
	type {{.Type}}Raw struct {
	  Contract *{{.Type}} // Generic contract binding to access the raw methods on
	}

	// {{.Type}}CallerRaw is an auto generated low-level read-only Go binding around an UTChain contract.
	type {{.Type}}CallerRaw struct {
		Contract *{{.Type}}Caller // Generic read-only contract binding to access the raw methods on
	}

	// {{.Type}}TransactorRaw is an auto generated low-level write-only Go binding around an UTChain contract.
	...
	{{range .Events}}
		...
		type {{$contract.Type}}{{.Normalized.Name}}Iterator struct {
			...
			sub  utereum.Subscription // Subscription for errors, completion and termination
...
import org.utereum.gut.*;
import org.utereum.gut.internal.*;
...
{{range $contract := .Contracts}}
	public class {{.Type}} {
		...
		{{if .InputBin}}
			...
			// deploy deploys a new UTChain contract, binding an instance of {{.Type}} to it.
			public static {{.Type}} deploy(TransactOpts auth, UTChainClient client{{range .Constructor.Inputs}}, {{bindtype .Type}} {{.Name}}{{end}}) throws Exception {
		...
		// UTChain address where this contract is located at.
		public final Address Address;

		// UTChain transaction in which this contract was deployed (if known!).
		...
		public {{.Type}}(Address address, UTChainClient client) throws Exception {
