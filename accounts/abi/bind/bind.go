...
// Package bind generates UTChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-utchain Wiki page:
// https://github.com/utchain/go-utchain/wiki/Native-DApps:-Go-bindings-to-UTChain-contracts
package bind
