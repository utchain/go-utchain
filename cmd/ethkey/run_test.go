...
// spawns utkey with the given command line args.
func runTstkey(t *testing.T, args ...string) *testTstkey {
	tt := new(testTstkey)
	tt.TestCmd = cmdtest.NewTestCmd(t, tt)
	tt.Run("utkey-test", args...)
	return tt
}

func TestMain(m *testing.M) {
	// Run the app if we've been exec'd as "utkey-test" in runTstkey.
	reexec.Register("utkey-test", func() {
