...
import (
	...
	"github.com/utchain/go-utchain/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the UTChain contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the UTChain contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the UTChain contract Solidity source to build and bind")
