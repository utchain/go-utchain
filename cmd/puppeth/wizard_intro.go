...
// setting up a new or managing an existing UTChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to pupptst, your UTChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new UTChain network down to  |")
	...
	log.Info("Administering UTChain network", "name", w.network)
