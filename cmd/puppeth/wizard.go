...
type wizard struct {
	...
	services map[string][]string   // UTChain services known to be running on servers
...
// converts it to an UTChain address. If an empty line is entered, the default
// value is returned.
