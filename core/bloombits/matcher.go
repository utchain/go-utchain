...
import (
	...
	"github.com/utchain/go-utchain/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors toguter.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toguter
				var orVector []byte
...
// the reuested retrieval queue to be serviced toguter with other sessions.
//
