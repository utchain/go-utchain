...
// stateObject represents an UTChain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of utereum address of the account
	data     Account
	db       *StateDB
...
// Account is the UTChain consensus representation of accounts.
