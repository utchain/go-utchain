...
// Package types contains data types related to UTChain consensus.
package types
...
// Header represents a block header in the UTChain blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) toguter.
type Body struct {
	Transactions []*Transaction
	Uncles       []*Header
}

// Block represents an entire block in the UTChain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the UTChain RLP block format.
