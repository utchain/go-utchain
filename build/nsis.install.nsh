Name "gut ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/utchain/go-utchain/issues"
!define UPDATEURL "https://github.com/utchain/go-utchain/releases"
!define ABOUTURL "https://github.com/utchain/go-utchain#utereum-go"
...
Section "Gtst" GTST_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gut.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gut.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gtst incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gut.exe" "" "" "UTChain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gtst outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gut.exe" "" "" "UTChain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gtst UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gut.exe" "" "" "UTChain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/utereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "TSTEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gut.ipc"
  ${EnvVarUpdate} $0 "TSTEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gut.ipc"
