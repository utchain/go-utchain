...
# 1. install gut for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gut
# 5. create gut, attach and uninstall start menu entries
...
!define GROUPNAME "UTChain"
!define APPNAME "Gtst"
!define DESCRIPTION "Official Go implementation of the UTChain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gut is installed global
