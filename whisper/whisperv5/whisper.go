...
// Whisper represents a dark communication interface through the UTChain
...
// New creates a Whisper client ready to communicate through the UTChain P2P network.
