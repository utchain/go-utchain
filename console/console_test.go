...
import (
	...
	"github.com/utchain/go-utchain/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*tst.Config)) *tester {
	...
	// Create a networkless protocol stack and start an UTChain service within
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return tst.New(ctx, tstConf) }); err != nil {
		t.Fatalf("failed to register UTChain protocol: %v", err)
	}
