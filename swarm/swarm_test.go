...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gut.ipc",
			endpoint:    "/data/testnet/gut.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gut.ipc",
			endpoint:    "/data/testnet/gut.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gut.ipc",
			endpoint:    "/data/testnet/gut.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gut.ipc",
			endpoint:    "/data/testnet/gut.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
