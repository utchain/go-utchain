// Copyright 2018 The go-utchain Authors
...
import (
	...
	gutmetrics "github.com/utchain/go-utchain/metrics"
	"github.com/utchain/go-utchain/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if gutmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(gutmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
