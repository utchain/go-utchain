...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gut.ipc", false, filepath.Join(os.TempDir(), "gut.ipc")},
		{"data", "gut.ipc", false, "data/gut.ipc"},
		{"data", "./gut.ipc", false, "./gut.ipc"},
		{"data", "/gut.ipc", false, "/gut.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gut.ipc", true, `\\.\pipe\gut.ipc`},
		{"data", "gut.ipc", true, `\\.\pipe\gut.ipc`},
		{"data", `\\.\pipe\gut.ipc`, true, `\\.\pipe\gut.ipc`},
	}
